...
contract AoriVaultTest is DSTest {
    ...
    function testBeforeAoriTrade_failNotOwner() public {
        ...
        aoriVault.beforeAoriTrade(matching, "0x3");
        vm.stopPrank();
    }
    ...
    function testAfterAoriTrade_failNotOwner() public {
        IAoriV2.MatchingDetails memory matching;

        vm.startPrank(FAKE_MAKER_WALLET);
        vm.expectRevert("Only a manager can force the execution of this trade");
        aoriVault.afterAoriTrade(matching, "0x3");
        vm.stopPrank();
    }
    ...
    function testHook_successNoDataWithAssets() public {
        ...
        vm.startPrank(address(aoriVault));
        tokenA.mint(1 ether);
    ...
    function testHook_successNoDataOnEoA() public {
        IAoriV2.Order memory makerOrder = IAoriV2.Order({
            offerer: MAKER_WALLET,
            inputToken: address(tokenA),
            inputAmount: 1,
